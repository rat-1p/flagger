...
func (kc *KnativeController) GetMetadata(canary *flaggerv1.Canary) (string, string, []flaggerv1.CanaryServicePort, error) {
	return "", "", make([]flaggerv1.CanaryServicePort, 0), nil
}
